...
export interface MessagesSlideInProps {
  size?: number;
  className?: string;
  isVisible?: boolean;
}
...
export function IconMessagesSlideIn({
  ...
  return (
    ...
    >
      <title>msgs</title>
      <g fill="none">
        {/* Back bubble (left/dark) - slides from left */}
        <motion.g
        ...
        >
          <path 
            ...
            fill="url(#msgs_slide_back)" 
            data-glass="origin" 
            mask="url(#msgs_slide_mask)" 
          />
          <path 
            d="M1 9.99348C1.00003 11.624 1.44063 13.1472 2.19626 14.4646C2.38601 14.9255 2.27792 15.4945 2.15636 15.9568C1.97097 16.6619 1.62172 17.3398 1.21379 17.7485C1.0104 17.9522 0.945503 18.2561 1.04846 18.525C1.1515 18.7939 1.40329 18.9771 1.69077 18.9927C2.51536 19.0372 3.42875 18.8742 4.22582 18.6419C4.83702 18.4638 5.42053 18.2318 5.88387 17.9889C7.15411 18.645 8.57122 18.9955 10.0009 18.9955C14.9719 18.9954 18.9997 14.9668 19 9.99728C19 5.05316 15.0118 1.04141 10.0779 1C5.1088 1.00007 1 5.02371 1 9.99348Z" 
            fill="url(#msgs_slide_back)" 
            data-glass="clone" 
            filter="url(#msgs_slide_filter)" 
            clipPath="url(#msgs_slide_clipPath)" 
          />
        </motion.g>

        {/* Front bubble (right/light) - slides from right */}
        <motion.g
          animate={isVisible ? 'visible' : 'hidden'}
        ...
        >
          ...
          <path 
            ...
            fill="url(#msgs_slide_outline)" 
          />
        </motion.g>

        <defs>
          <linearGradient id="msgs_slide_back" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse">
            <stop stopColor="#575757" />
            <stop offset="1" stopColor="#151515" />
          </linearGradient>
          <linearGradient id="msgs_slide_front" x1="15.5" y1="7.25" x2="15.5" y2="21.75" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E3E3E5" stopOpacity=".6" />
            <stop offset="1" stopColor="#BBBBC0" stopOpacity=".6" />
          </linearGradient>
          <linearGradient id="msgs_slide_outline" x1="15.5" y1="7.25" x2="15.5" y2="15.647" gradientUnits="userSpaceOnUse">
            <stop stopColor="#fff" />
            <stop offset="1" stopColor="#fff" stopOpacity="0" />
          </linearGradient>
          <filter id="msgs_slide_filter" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse">
            <feGaussianBlur stdDeviation="2" x="0%" y="0%" width="100%" height="100%" in="SourceGraphic" edgeMode="none" result="blur" />
          </filter>
          <clipPath id="msgs_slide_clipPath">
            <path d="M22.75 14.4971C22.75 15.8083 22.3947 17.0325 21.7881 18.0918C21.4381 18.7473 22.0797 20.0133 22.5303 20.4648C22.7394 20.6742 22.8061 20.9874 22.7002 21.2637C22.5942 21.5399 22.3354 21.7282 22.04 21.7441C21.3651 21.7806 20.6264 21.6475 19.9893 21.4619C19.536 21.3299 19.098 21.1595 18.7354 20.9775C17.7323 21.4798 16.6207 21.7461 15.499 21.7461C11.4948 21.7459 8.2502 18.5019 8.25 14.5C8.25 10.498 11.4977 7.25 15.501 7.25C19.5037 7.25018 22.75 10.4949 22.75 14.4971Z" fill="url(#msgs_slide_front)" />
          </clipPath>
          <mask id="msgs_slide_mask">
