...
function UIVariationDetail({
  ...
  return (
    <>
      {/* ── Middle: name + description + configurator ── */}
      ...
      {/* ── Right: install + props + features + inspiration ── */}
      <div className={`overflow-y-auto py-10 px-6 ${RIGHT_PANEL_SHADOW}`}>
        ...
        >
          ...
          <div>
            ...
            <UsageBlock snippet={activeSnippet} />
          </div>
                            ...
                            <span className="font-mono text-foreground/70 whitespace-nowrap">
                              {prop.options.map((o, i) => (
                                <span key={o}>
                                  ...
                                  <code className="text-foreground/80">&ldquo;{o}&rdquo;</code>
                                </span>
                              ))}
                            </span>
                          ) : prop.min !== undefined && prop.max !== undefined ? (
                            <span className="font-mono text-foreground/60 whitespace-nowrap">
