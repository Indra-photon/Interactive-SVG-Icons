...
export const Paragraph = <T extends React.ElementType = "p">({
  ...
  const variants = {
    ...
    body: "tracking-tighter text-[13px] sm:text-[14px] md:text-[14px] lg:text-[15px] leading-normal text-secondary-foreground/60 text-pretty",
    ...
    lead: "tracking-normal text-[13px] sm:text-[14px] md:text-[14px] lg:text-[15px] leading-normal text-secondary-foreground/60 text-pretty",
