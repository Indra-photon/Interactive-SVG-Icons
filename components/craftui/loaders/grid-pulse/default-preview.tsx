...
export default function GridPulsePreview() {
  const { color = "currentColor", dotSize = 16, duration = 1.6, ease = "easeInOut", gridSize = 3 } = useLoaderProps();
