...
export function IconLockUnlock({
  ...
  return (
    <svg 
      ...
      overflow="visible"
      className={className}
      style={{ perspective: '400px' }} // Enable 3D space
    >
      <title>lock</title>
      <g fill="none">
        {/* Shackle - lifts and rotates in 3D with right side as hinge */}
        <motion.g
          animate={isUnlocked ? 'unlocked' : 'locked'}
          variants={shackleVariants}
          style={{ 
            transformBox: 'fill-box',
            transformOrigin: 'right bottom', // Right edge of shackle
        ...
        >
          <path 
            ...
            fill="url(#lock_unlock_shackle)" 
            data-glass="origin" 
            mask="url(#lock_unlock_mask)" 
          />
          <path 
            d="M16 12V6C16 3.79086 14.2091 2 12 2C9.79086 2 8 3.79086 8 6V12C8 12.5523 7.55228 13 7 13C6.44772 13 6 12.5523 6 12V6C6 2.68629 8.68629 0 12 0C15.3137 0 18 2.68629 18 6V12C18 12.5523 17.5523 13 17 13C16.4477 13 16 12.5523 16 12Z" 
            fill="url(#lock_unlock_shackle)" 
            data-glass="clone" 
            filter="url(#lock_unlock_filter)" 
            clipPath="url(#lock_unlock_clipPath)" 
          />
        </motion.g>

        {/* Lock body - slight scale pulse on unlock */}
        <motion.g
          animate={isUnlocked ? 'unlocked' : 'locked'}
        ...
        >
          ...
          <path 
            ...
            stroke="url(#lock_unlock_outline)" 
            strokeWidth=".75" 
          />
        </motion.g>

        <defs>
          <linearGradient id="lock_unlock_shackle" x1="12" y1="0" x2="12" y2="13" gradientUnits="userSpaceOnUse">
            <stop stopColor="#575757" />
            <stop offset="1" stopColor="#151515" />
          </linearGradient>
          <linearGradient id="lock_unlock_body" x1="12" y1="9" x2="12" y2="23" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E3E3E5" stopOpacity=".6" />
            <stop offset="1" stopColor="#BBBBC0" stopOpacity=".6" />
          </linearGradient>
          <linearGradient id="lock_unlock_outline" x1="12" y1="9" x2="12" y2="17.108" gradientUnits="userSpaceOnUse">
            <stop stopColor="#fff" />
            <stop offset="1" stopColor="#fff" stopOpacity="0" />
          </linearGradient>
          <filter id="lock_unlock_filter" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox" primitiveUnits="userSpaceOnUse">
            <feGaussianBlur stdDeviation="2" x="0%" y="0%" width="100%" height="100%" in="SourceGraphic" edgeMode="none" result="blur" />
          </filter>
          <clipPath id="lock_unlock_clipPath">
            <path d="M3 15.4V16.6C3 18.8402 3 19.9603 3.43597 20.816C3.81947 21.5686 4.43139 22.1805 5.18404 22.564C6.03969 23 7.15979 23 9.4 23H14.6C16.8402 23 17.9603 23 18.816 22.564C19.5686 22.1805 20.1805 21.5686 20.564 20.816C21 19.9603 21 18.8402 21 16.6V15.4C21 13.1598 21 12.0397 20.564 11.184C20.1805 10.4314 19.5686 9.81947 18.816 9.43597C17.9603 9 16.8402 9 14.6 9H9.4C7.15979 9 6.03969 9 5.18404 9.43597C4.43139 9.81947 3.81947 10.4314 3.43597 11.184C3 12.0397 3 13.1598 3 15.4Z" fill="url(#lock_unlock_body)" />
          </clipPath>
          <mask id="lock_unlock_mask">
